...
experiences:
  ...
  - group:
      - org: Audika
        city: Dijon
        role: Audioprothésiste D.E / Membre du comité scientifique
        date: '2013-2018'
        highlights:
...
formations:
  - title: Audiophonologie et Otologie de l’enfant, Paris - D.U
    date: '2017-2018'
  - title: Audiologie avancée, Lyon - D.U
    date: '2015-2016'
...
media:
  - title: Astrone, la nouvelle plateforme d’audiométrie avancée
...
associations:
  - name: Astrone
    ...
    description: Plateforme d'audiométrie où le clinicien compose ses propres tests à partir de briques élémentaires, portée par un moteur audio maison (Web Audio API, DSP temps réel).
...
Audioprothésiste D.E formé à la recherche clinique au CHU de Dijon, devenu développeur pour construire les outils qui me manquaient en cabinet. Je conçois et développe seul Astrone, une plateforme d'audiométrie avancée utilisée par 250 cliniciens chaque semaine, dont le moteur audio temps réel est écrit de A à Z. Clinique, recherche et code sur le même sujet : l'audition.
